...
<head>
    ...
    <link rel="shortcut icon" href="https://www.avishost.com/fav.png" />
        ...
        <div class="container">
            ...
            <div class="collapse navbar-collapse" id="primary-nav">
                ...
                <ul class="nav navbar-nav">
                    ...
                    <li menuitemname="pm-addon-overview" class="" id="Primary_Navbar-pm-addon-overview">
                        <a href="{$WEB_ROOT}/knowledgebase.php">آموزش</a>
            </li>
                </ul>
