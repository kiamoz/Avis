...
foreach ($invoiceitems as $item) {
    $tblhtml .= '
    <tr bgcolor="#fff">
<td align="center">' . pdfdescription(nl2br($item['description'])) . '<br /></td>
        <td align="center"  >' .number_format( str_replace(",","", $item['amount'])  )   . '</td>
    </tr>';
}
$tblhtml .= '
    <tr height="30" bgcolor="#efefef" style="font-weight:bold;">
        <td align="right">' . Lang::trans('invoicessubtotal') . '</td>
        <td align="center">' .  number_format( str_replace(",","",$subtotal)  ) . '</td>
    </tr>';
if ($taxname) {
    $tblhtml .= '
    <tr height="30" bgcolor="#efefef" style="font-weight:bold;">
...
$tblhtml .= '
    ...
    <tr height="30" bgcolor="#efefef" style="font-weight:bold;">
        ...
        <td align="center">' .  number_format( str_replace(",","",$total)  )   . '</td>
    </tr>
</table>';
...
if (!count($transactions)) {
    ...
    foreach ($transactions AS $trans) {
        ...
        <tr bgcolor="#fff">
            ...
            <td align="center" >' .   number_format( str_replace(",","",$trans['amount'])  )  . '</td>
        </tr>';
    }
}
$tblhtml .= '
    <tr height="30" bgcolor="#efefef" style="font-weight:bold;">
        ...
        <td align="center">' . number_format( str_replace(",","",$balance)  ) . '</td>
    </tr>
</table>';
