...
<html lang="en">
    <head>
        ...
        <link href='moz.css?v={$random}' rel='stylesheet' type='text/css'>
                ...
                <div class="container">
                    ...
                    <div class="collapse navbar-collapse" id="primary-nav">
                        ...
                        <ul class="nav navbar-nav">
                            ...
                            <li menuitemname="Home" class="" id="Primary_Navbar-Home" style="background: #69b0da;">
                                <a href="/frontend/web/billing/knowledgebase.php">
                                    آموزش ها
                                </a>
                            </li>
