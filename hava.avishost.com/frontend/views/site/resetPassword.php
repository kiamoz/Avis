              ...
              <div class="row justify-content-center">
                <div class="col-xl-6 col-lg-8 col-md-8 ">
                    ...
                    <div class="row">
                      ...
                      <div class="col-12">
                        <div class="input-box">
                          <label for="login-email">لطفا شماره همراه خود را وارد کنید در صورتی صحت و وجود شماره تلفن رمز جدید به شما پیامک می شود</label>
                           <input class="active-form" name="sms_token"  type="text"/>
