...
<div class="farayand-moalefe-form">
    ...
    <?=
    $form->field($model, 'bod_id')->widget(Select2::classname(), [
        'data' => \yii\helpers\ArrayHelper::map(\common\models\FarayandBod::find()->all(), 'id', 'name'),
