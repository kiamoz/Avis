...
echo $this->renderDynamic(' if(!Yii::$app->user->id){ Yii::$app->response->redirect(["site/login"]);}');
...
<div class="row">
    ...
    <div class="col-md-12">
        <div class="panel">
            <div class="panel-body">
                <h3 class="title-hero">
                    نمودار تمام هزنیه های به صورت خطی
                </h3>
                <div class="example-box-wrapper">
